    ...
    <script>
        ...
        $data = [
            ...
            [
                ...
                "items" => [
                    [
                        "description" => "Saya yang bertanda tangan di bawah ini menyatakan telah membaca, memahami, dan menyetujui seluruh Ketentuan Kartu Pelajar dan akses SIP yang tercantum di atas."
                    ],
                    [
                    ...
                    [
                        "description" => "Pemakaian kartu pelajar sebagai kartu diskon, akses ke perpustakaan, Tabungan pelajar, kartu pembayaran non-tunai, dan akses ke SIP (Student Information & Payment) adalah merupakan tanggung jawab saya dan anak saya sepenuhnya."
                    ],
                    [
                        "description" => "Saya membebaskan pihak Sekolah atas kelalaian atau penyalahgunaan kartu baik oleh saya atau anak saya."
                    ]
                ]
            ]
        ] ?>
