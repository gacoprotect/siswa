...
import "lucide-react";
const PinPage = ({ setOpenSetupPin, hasPin, open, onClose }) => {
  const { errors, nouid } = usePage().props;
  ...
  return /* @__PURE__ */ jsx(Modal, { title: hasPin ? "" : "Anda Belum Membuat PIN", isOpen: open, onClose, children: hasPin ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center", children: [
