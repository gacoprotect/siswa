...
import { M as Modal } from "./Modal-DWGW2vB4.js";
import { m as maskPhoneNumber } from "./utils-DODlBKb1.js";
...
const SetupPinPage = ({ setHasPined, hasPin, open, onClose }) => {
  const { siswa, message, errors, nouid } = usePage().props;
  ...
  const handlePhoneSubmit = (e) => {
    e.preventDefault();
    const url = hasPin ? route("siswa.forgot-pin", { nouid }) : route("otp.send", { nouid });
    post(url, {
      onSuccess: () => {
        setStep("otp");
        setCountdown(60);
  ...
  const renderOtpStep = () => /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    errors && /* @__PURE__ */ jsx("div", { className: "text-center text-sm text-red-500", children: errors.message }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleOtpSubmit, className: "space-y-6", children: [
      /* @__PURE__ */ jsx("div", { className: "flex justify-center space-x-2", children: Array.from({ length: 6 }).map((_, index) => /* @__PURE__ */ jsx(
        "input",
        {
          ...
          required: true,
          autoComplete: "off",
          className: `h-12 w-12 rounded-md border text-center text-2xl focus:ring-1 focus:outline-none ${errors.otp ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:border-blue-500 focus:ring-blue-500"}`,
  ...
  return /* @__PURE__ */ jsx(Modal, { isOpen: open, onClose, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md rounded-lg", children: [
      message && /* @__PURE__ */ jsx("div", { className: `mb-4 text-center text-sm ${message.includes("berhasil") ? "text-green-600" : "text-red-500"}`, children: message }),
